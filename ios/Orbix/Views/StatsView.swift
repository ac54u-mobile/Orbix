...
struct StatsView: View {
    ...
    private func speedCard(icon: String, color: Color, label: String, value: String) -> some View {
        ...
        .padding(12)
        .liquidGlass(.thick, cornerRadius: 14)
        .frame(maxWidth: .infinity)
    }

    // MARK: - Glass Card Section Helper
    private func statSection(title: String, @ViewBuilder rows: () -> some View) -> some View {
        VStack(alignment: .leading, spacing: StatsViewConfig.elementSpacing) {
    ...
    private var serverSection: some View {
        statSection(title: String(localized: "服务器", comment: "Server")) {
    ...
    private var historySection: some View {
        if let s = serverState {
            statSection(title: String(localized: "历史统计", comment: "History stats")) {
    ...
    private var sessionSection: some View {
        let t = transfer
        return statSection(title: String(localized: "当前会话", comment: "Current session")) {
    ...
    private var serverInfoSection: some View {
        statSection(title: String(localized: "服务器信息", comment: "Server info")) {
    ...
    private var torrentStatusSection: some View {
        ...
        return statSection(title: String(localized: "种子状态", comment: "Torrent status")) {
